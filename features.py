"""
Gather relevance scores for given docId,keyword,features pairs
"""
import json
...
if __name__ == "__main__":
    ...
    esUrl, index, searchType = parseUrl(argv[1])
    es = Elasticsearch(esUrl)
    judgements = judgmentsByQid(judgmentsFromFile(filename='sample_judgements.txt'))
    kwDocFeatures(es, index=index, searchType=searchType, judgements=judgements)
